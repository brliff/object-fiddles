...
//After you've made your object, add another key named 'car' with the value being your favorite car and then another key named 'brand' with the value being your favorite brand.
  ...
  //Code here
favoriteThings.car = "The Garth Mobile";
...
// backPack['firstPocket'] = 'chapstick';      //Another way to use bracket notation.
...
// information.
  ...
  //Code Here
user1.name = 'Brad Lifferth';
user1.username = 'bradlifferth@outlook.com';
...
either a person or credit card object.
   ...
   properties from the person as well as the creditcard. While Object.assign would give you
   the answer, specRunner requires an answer without using it.
*/
...
var brad = makePerson('Brad Lifferth', 'April 22', '111-11-111');
var card = creditcard('1234566789', '01/18', 222);
var bindedObj =  extend(brad, card);

console.log(bindCard(bindedObj));